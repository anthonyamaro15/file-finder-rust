...
use file_finder::directory_store::{
    build_directory_from_store, load_directory_from_file, save_directory_to_file, DirectoryStore,
};
...
mod directory_store_file_operations_tests {
    ...
    fn test_save_and_load_directory_store() {
        ...
        assert!(loaded_store
            .directories
            .contains(&"/home/user/documents".to_string()));
        assert!(loaded_store
            .directories
            .contains(&"/home/user/pictures".to_string()));
        assert!(loaded_store
            .directories
            .contains(&"/home/user/downloads".to_string()));
    }
...
mod build_directory_store_tests {
    ...
    fn test_build_directory_from_store_with_ignore() {
        ...
        assert!(!store
            .directories
            .iter()
            .any(|dir| dir.contains("node_modules")));
...
mod configuration_tests {
    ...
    fn test_configuration_paths_format() {
        ...
        assert!(config
            .cache_directory
            .contains(".config/ff/cache_directory.json"));
...
mod configuration_file_operations_tests {
    ...
    fn test_configuration_serialization_deserialization() {
        ...
        assert_eq!(
            ...
            deserialized_config.ignore_directories
        );
...
mod configuration_directory_creation_tests {
    ...
    fn test_handle_settings_configuration_creates_files() {
        ...
        config
            .handle_settings_configuration()
            .expect("Failed to handle settings configuration");
    ...
    fn test_handle_settings_configuration_loads_existing() {
        ...
        let json_content =
            serde_json::to_string(&custom_config).expect("Failed to serialize config");
